...
const SearchPost = () => {
  ...
  return (
    ...
    >
      <Form>
        <div className="flex flex-col items-center justify-center max-w-screen-md mx-auto border-solid border border-slate-500 shadow-xl py-10 px-20 rounded-full">
